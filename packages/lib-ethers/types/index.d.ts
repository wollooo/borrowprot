...
interface BorrowerOperationsCalls {
    ...
    kumoParameters(_overrides?: CallOverrides): Promise<string>;
...
export interface BorrowerOperations extends _TypedLiquityContract<BorrowerOperationsCalls, BorrowerOperationsTransactions> {
    ...
    extractEvents(logs: Log[], name: "VaultParametersBaseChanged"): _TypedLogDescription<{
        newAddress: string;
    }>[];
}
...
interface KumoParametersCalls {
    ...
    DECIMAL_PRECISION(_overrides?: CallOverrides): Promise<BigNumber>;
    KUMO_GAS_COMPENSATION(arg0: string, _overrides?: CallOverrides): Promise<BigNumber>;
    KUMO_GAS_COMPENSATION_DEFAULT(_overrides?: CallOverrides): Promise<BigNumber>;
...
interface KumoParametersTransactions {
    ...
    setAsDefaultWithRemptionBlock(_asset: string, blockInDays: BigNumberish, _overrides?: Overrides): Promise<void>;
...
export interface KumoParameters extends _TypedLiquityContract<KumoParametersCalls, KumoParametersTransactions> {
    readonly filters: {
    ...
    extractEvents(logs: Log[], name: "BorrowingFeeFloorChanged"): _TypedLogDescription<{
        oldBorrowingFloorFee: BigNumber;
        newBorrowingFloorFee: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "CCRChanged"): _TypedLogDescription<{
        oldCCR: BigNumber;
        newCCR: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "GasCompensationChanged"): _TypedLogDescription<{
        oldGasComp: BigNumber;
        newGasComp: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "MCRChanged"): _TypedLogDescription<{
        oldMCR: BigNumber;
        newMCR: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "MaxBorrowingFeeChanged"): _TypedLogDescription<{
        oldMaxBorrowingFee: BigNumber;
        newMaxBorrowingFee: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "MinNetDebtChanged"): _TypedLogDescription<{
        oldMinNet: BigNumber;
        newMinNet: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{
    ...
    extractEvents(logs: Log[], name: "PercentDivisorChanged"): _TypedLogDescription<{
        oldPercentDiv: BigNumber;
        newPercentDiv: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "PriceFeedChanged"): _TypedLogDescription<{
        addr: string;
    }>[];
    extractEvents(logs: Log[], name: "RedemptionBlockRemoved"): _TypedLogDescription<{
        _asset: string;
    }>[];
    extractEvents(logs: Log[], name: "RedemptionFeeFloorChanged"): _TypedLogDescription<{
