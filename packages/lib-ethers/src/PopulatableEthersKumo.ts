...
export interface BorrowingOperationOptionalParams {
  /**
   * Maximum acceptable {@link @kumo/lib-base#Fees.borrowingRate | borrowing rate}
...
export class PopulatedEthersKumoTransaction<T = unknown>
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatedKumoTransaction.send} */
...
/**
 * {@inheritDoc @kumo/lib-base#PopulatedRedemption}
 *
 * @public
 */
export class PopulatedEthersRedemption
  ...
  implements
    PopulatedRedemption<
      ...
      EthersTransactionReceipt
    > {
  /** {@inheritDoc @kumo/lib-base#PopulatedRedemption.attemptedKUSDAmount} */
  readonly attemptedKUSDAmount: Decimal;

  /** {@inheritDoc @kumo/lib-base#PopulatedRedemption.redeemableKUSDAmount} */
  readonly redeemableKUSDAmount: Decimal;

  /** {@inheritDoc @kumo/lib-base#PopulatedRedemption.isTruncated} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatedRedemption.increaseAmountByMinimumNetDebt} */
  increaseAmountByMinimumNetDebt(
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedEthersRedemption> {
...
/**
 * Ethers-based implementation of {@link @kumo/lib-base#PopulatableKumo}.
 *
 * @public
 */
export class PopulatableEthersKumo
  ...
  private async _findHintsForNominalCollateralRatio(
    ...
    // (See https://github.com/kumo/dev/issues/600).
    if (prev === AddressZero) {
      prev = next;
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.closeTrove} */
  async closeTrove(
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersKumoTransaction<TroveClosureDetails>> {
    const { borrowerOperations } = _getContracts(this._readable.connection);
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.borrowKUSD} */
  borrowKUSD(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.repayKUSD} */
  repayKUSD(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.adjustTrove} */
  async adjustTrove(
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.liquidate} */
  async liquidate(
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.liquidateUpTo} */
  async liquidateUpTo(
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.depositKUSDInStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.withdrawKUSDFromStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.sendKUSD} */
  async sendKUSD(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.sendKUMO} */
  async sendKUMO(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.redeemKUSD} */
  async redeemKUSD(
    amount: Decimalish,
    maxRedemptionRate?: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.stakeKUMO} */
  async stakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.unstakeKUMO} */
  async unstakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.registerFrontend} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.approveUniTokens} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.stakeUniTokens} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.unstakeUniTokens} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.withdrawKUMORewardFromLiquidityMining} */
  ...
  /** {@inheritDoc @kumo/lib-base#PopulatableKumo.exitLiquidityMining} */
