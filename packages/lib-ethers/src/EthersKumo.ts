...
export class EthersKumo implements ReadableEthersKumo, TransactableKumo {
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getTotalRedistributed} */
  getTotalRedistributed(overrides?: EthersCallOverrides): Promise<Trove> {
    return this._readable.getTotalRedistributed(overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getTroveBeforeRedistribution} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getTotal} */
  getTotal(overrides?: EthersCallOverrides): Promise<Trove> {
    return this._readable.getTotal(overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getStabilityDeposit} */
  getStabilityDeposit(address?: string, overrides?: EthersCallOverrides): Promise<StabilityDeposit> {
    return this._readable.getStabilityDeposit(address, overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getRemainingStabilityPoolKUMOReward} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getKUSDInStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getKUSDBalance} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getKUMOBalance} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getUniTokenBalance} */
  getUniTokenBalance(address?: string, overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getUniTokenBalance(address, overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getUniTokenAllowance} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getRemainingLiquidityMiningKUMOReward} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getLiquidityMiningStake} */
  getLiquidityMiningStake(address?: string, overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getLiquidityMiningStake(address, overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getTotalStakedUniTokens} */
  getTotalStakedUniTokens(overrides?: EthersCallOverrides): Promise<Decimal> {
    return this._readable.getTotalStakedUniTokens(overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getLiquidityMiningKUMOReward} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getCollateralSurplusBalance} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.(getTroves:2)} */
  ...
  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getFees} */
  getFees(overrides?: EthersCallOverrides): Promise<Fees> {
    return this._readable.getFees(overrides);
  }

  /** {@inheritDoc @kumo/lib-base#ReadableKumo.getKUMOStake} */
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.closeTrove}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.adjustTrove}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.depositCollateral}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.withdrawCollateral}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.borrowKUSD}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.repayKUSD}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.liquidate}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.liquidateUpTo}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.depositKUSDInStabilityPool}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.withdrawKUSDFromStabilityPool}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.withdrawGainsFromStabilityPool}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.transferCollateralGainToTrove}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.sendKUSD}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.sendKUMO}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.redeemKUSD}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.claimCollateralSurplus}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.stakeKUMO}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.unstakeKUMO}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.withdrawGainsFromStaking}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.registerFrontend}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.approveUniTokens}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.stakeUniTokens}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.unstakeUniTokens}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.withdrawKUMORewardFromLiquidityMining}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
  ...
  /**
   * {@inheritDoc @kumo/lib-base#TransactableKumo.exitLiquidityMining}
   *
   * @throws
   * Throws {@link EthersTransactionFailedError} in case of transaction failure.
   * Throws {@link EthersTransactionCancelledError} if the transaction is cancelled or replaced.
...
/**
 * Variant of {@link EthersKumo} that exposes a {@link @kumo/lib-base#KumoStore}.
 *
 * @public
 */
