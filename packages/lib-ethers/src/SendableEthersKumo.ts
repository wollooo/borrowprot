...
/**
 * Ethers-based implementation of {@link @kumo/lib-base#SendableKumo}.
 *
 * @public
 */
export class SendableEthersKumo
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.closeTrove} */
  closeTrove(
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.adjustTrove} */
  adjustTrove(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.borrowKUSD} */
  borrowKUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.repayKUSD} */
  repayKUSD(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.liquidate} */
  liquidate(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.liquidateUpTo} */
  liquidateUpTo(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.depositKUSDInStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.withdrawKUSDFromStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.sendKUSD} */
  sendKUSD(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.sendKUMO} */
  sendKUMO(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.redeemKUSD} */
  redeemKUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.stakeKUMO} */
  stakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.unstakeKUMO} */
  unstakeKUMO(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.registerFrontend} */
  registerFrontend(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.approveUniTokens} */
  approveUniTokens(
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.stakeUniTokens} */
  stakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.unstakeUniTokens} */
  unstakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.withdrawKUMORewardFromLiquidityMining} */
  ...
  /** {@inheritDoc @kumo/lib-base#SendableKumo.exitLiquidityMining} */
  exitLiquidityMining(
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersKumoTransaction<void>> {
