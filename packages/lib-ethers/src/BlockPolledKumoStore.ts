...
/**
 * Extra state added to {@link @kumo/lib-base#KumoStoreState} by
 ...
 * {@link @kumo/lib-base#KumoStore.state | state}.
 *
 * @public
 */
...
/**
 * Ethers-based {@link @kumo/lib-base#KumoStore} that updates state whenever there's a new
 * block.
 *
 * @public
 */
