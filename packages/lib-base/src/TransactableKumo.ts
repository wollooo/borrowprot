 ...
 *
 * Implemented by {@link @kumo/lib-ethers#EthersKumo}.
 *
 * @public
 */
export interface TransactableKumo {
   ...
   *                           {@link @kumo/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @kumo/lib-base#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link @kumo/lib-base#KUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link @kumo/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @kumo/lib-base#StabilityDeposit.kumoReward | KUMO reward}.
   */
  ...
  /**
   * Withdraw {@link @kumo/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @kumo/lib-base#StabilityDeposit.kumoReward | KUMO reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link @kumo/lib-base#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link @kumo/lib-base#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link @kumo/lib-base#ReadableKumo.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link @kumo/lib-base#KUMOStake.collateralGain | collateral gain} and
   * {@link @kumo/lib-base#KUMOStake.kusdGain | KUSD gain}.
   */
  ...
  /**
   * Withdraw {@link @kumo/lib-base#KUMOStake.collateralGain | collateral gain} and
   * {@link @kumo/lib-base#KUMOStake.kusdGain | KUSD gain} from KUMO stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * {@link @kumo/lib-base#TransactableKumo.stakeUniTokens | staking}.
   *
   ...
   * {@link @kumo/lib-base#TransactableKumo.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
