 ...
 *
 * @remarks
 * Implemented by {@link @kumo/lib-ethers#SentEthersKumoTransaction}.
 *
 * @public
 */
export interface SentKumoTransaction<S = unknown, T extends KumoReceipt = KumoReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @kumo/lib-base#SentKumoTransaction.waitForReceipt | waitForReceipt()},
   ...
   *
   * @returns Either a {@link @kumo/lib-base#FailedReceipt} or a
   *          {@link @kumo/lib-base#SuccessfulReceipt}.
   */
 ...
 *
 * Implemented by {@link @kumo/lib-ethers#SendableEthersKumo}.
 *
 * @public
 */
