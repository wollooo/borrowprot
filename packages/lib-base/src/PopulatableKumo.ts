 ...
 *
 * @remarks
 * Implemented by {@link @kumo/lib-ethers#PopulatedEthersKumoTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @kumo/lib-base#SentKumoTransaction}.
   */
  send(): Promise<T>;
}
 ...
 * {@link @kumo/lib-base#KUSD_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some KUSD amounts are not possible to redeem exactly.
 *
 * When {@link @kumo/lib-base#PopulatableKumo.redeemKUSD | redeemKUSD()} is called with an
 ...
 * {@link @kumo/lib-base#PopulatedRedemption.increaseAmountByMinimumNetDebt | increasing the amount}
 * to the next lowest possible value, which is the sum of the truncated amount and
 * {@link @kumo/lib-base#KUSD_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
   ...
   *                            {@link @kumo/lib-base#Fees.redemptionRate | redemption rate} to
 ...
 *
 * Implemented by {@link @kumo/lib-ethers#PopulatableEthersKumo}.
 *
 * @public
 */
