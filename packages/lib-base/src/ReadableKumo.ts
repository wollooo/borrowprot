...
export interface ReadableKumo {
   ...
   *
   * @remarks
   * Needed when dealing with instances of {@link @kumo/lib-base#TroveWithPendingRedistribution}.
   */
   ...
   * {@link @kumo/lib-base#ReadableKumo.getTrove | getTrove()}.
   */
   ...
   * {@link @kumo/lib-base#TransactableKumo.claimCollateralSurplus | claimCollateralSurplus()}.
   */
