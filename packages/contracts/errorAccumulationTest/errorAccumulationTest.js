...
contract('TroveManager', async accounts => {
  ...
  it("11 accounts with random coll. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
    ...
    const USDVDebt_DefaultPool = await defaultPool.getLUSDDebt()
    console.log(`ETH left in Default Pool is: ${ETH_DefaultPool}`)
    console.log(`LUSDDebt left in Default Pool is: ${USDVDebt_DefaultPool}`)
  })
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    for (account of accounts.slice(1, 11)) {
      ...
      const defaultPoolUSDVDebt = await defaultPool.getLUSDDebt()
    ...
    console.log(`Accumulated LUSDDebt difference between Active and Default Pools is: ${totalUSDVDebtPoolDifference}`)
  })
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalUSDVRewards = (totalColl.mul(L_LUSDDebt)).div(_1e18_BN)
    ...
    console.log(`LUSDDebt difference between total pending rewards and DefaultPool: ${USDVDebtRewardDifference} `)
  })
  ...
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalUSDVRewards_Distribution = (totalColl.mul(L_LUSDDebt)).div(_1e18_BN)
    ...
    console.log(`LUSDDebt difference between total pending distribution rewards and DefaultPool: ${USDVDebtRewardDifference} `)
  })
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    const SP_USDV = await stabilityPool.getTotalLUSDDeposits()
    ...
    console.log(`LUSD insufficiency in Stability Pool is ${SP_USDV_Insufficiency}`)
  })
